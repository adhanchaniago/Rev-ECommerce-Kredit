...
echo buatSubMenu('Informasi','menu-icon fa fa-info-circle',
                      array(
...
echo buatSubMenu('Barang','menu-icon fa fa-folder-o',
                      array(
...
echo buatSubMenu('Laporan','menu-icon fa fa-file-text-o',
                      array(
