<div class="page-content">
	<div class="page-header">
		<h1 style="color:#585858">
			<i style="margin-right:7px" class="ace-icon fa fa-folder-o"></i> Data Admin
                            	...
                            	<tr>
									...
									<td width="80" class="center">
										<div class="action-buttons">
											<a data-rel="tooltip" data-placement="top" title="Ubah" style="margin-right:5px" class="blue tooltip-info" href="?module=form_admin&form=edit&id=<?php echo $data['id_admin']; ?>">
												<i class="ace-icon fa fa-edit bigger-130"></i>
											</a>

											<a data-rel="tooltip" data-placement="top" title="Hapus" class="red tooltip-error" href="modules/admin/proses.php?act=delete&id=<?php echo $data['id_admin'];?>" onclick="return confirm('Anda yakin ingin menghapus admin barang <?php echo $data['nama_kategori']; ?> ?');">
